...
public class GlobalExceptionHandler
{
    ...
    public ResponseEntity<ResponseWrapper<ErrorResponse>> handleValidationException(
    ...
    public ResponseEntity<ResponseWrapper<ErrorResponse>> handleIllegalArgumentException(
    ...
    public ResponseEntity<ResponseWrapper<ErrorResponse>> handleNoResourceFound(
    ...
    public ResponseEntity<ResponseWrapper<ErrorResponse>> handleGenericException(
            Exception ex,
            WebRequest request)
        {
        ErrorResponse error = new ErrorResponse(
